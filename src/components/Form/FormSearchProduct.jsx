    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit}>
                <div className='flex items-center justify-between w-[500px] border rounded-md border-black pl-4 bg-white'>
                    ...
                    <button type='submit' className='p-2 text-sm bg-green-700 m-1 rounded-md'><i className="fa-solid fa-magnifying-glass"></i></button>
                </div>
            </form>
